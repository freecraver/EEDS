...
#fit_seasonal<-auto.arima(energy$power[-c(LL:L)],seasonal = TRUE)
fit_non_seasonal<-auto.arima(energy$power_clean[-c(LL:L)],seasonal = FALSE)
...
#lines(energy.df$power)
points(energy$extracted,col="red",pch = ".")
#lines(energy$power[LL:L])
accuracy(fcast_non_seasonal)
